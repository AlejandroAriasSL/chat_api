...
public class LoginUseCase implements UserUseCase<LoginRequestDTO, UserDTO> {

    private final UserService userService;
    private final AuthenticationManager authenticationManager;

    public LoginUseCase(UserService userService, AuthenticationManager authenticationManager) {
        this.userService = userService;
        this.authenticationManager = authenticationManager;
    }

    public UserDTO execute(LoginRequestDTO request) {
